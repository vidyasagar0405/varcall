...
class BcftoolsWidgets(Static):
    def compose(self) -> ComposeResult:
        ...
        with Grid(id="bcf_mpileup_container"):
        ...
        with Grid(id="bcf_call_container"):
        ...
        with Grid(id="bcf_filter_container"):
        ...
        with Grid(id="bcf_norm_container"):
        ...
        with Grid(id="bcf_stats_container"):
